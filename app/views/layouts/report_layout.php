		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">Sistema de controle de casos</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Telefone: <span class="sub-title">(17) 3347-9900</span></div>
						<div>Email: <span class="sub-title">contato@jaborandi.sp.gov.br</span></div>
						<div>Web: <span class="sub-title">jaborandi.sp.gov.br</span></div>
					</div>
