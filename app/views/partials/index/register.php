                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-login"  value="<?php  echo $this->set_field_value('login',""); ?>" type="text" placeholder="Entrar  Login"  required="" name="login"  data-url="api/json/usuario_login_value_exist/" data-loading-msg="Checando disponibilidade ..." data-available-msg="Disponível" data-unavailable-msg="Não disponível" class="form-control  ctrl-check-duplicate" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-email"  value="<?php  echo $this->set_field_value('email',""); ?>" type="email" placeholder="Entrar  Email"  required="" name="email"  data-url="api/json/usuario_email_value_exist/" data-loading-msg="Checando disponibilidade ..." data-available-msg="Disponível" data-unavailable-msg="Não disponível" class="form-control  ctrl-check-duplicate" />
                                                            <div class="check-status"></div> 
                                                        </div>
                                                    </div>
                                                </div>
