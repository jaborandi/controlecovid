...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h2 class="record-title">Adicionar novo</h2>
                    <h5>Preencha apenas os dados que você possui, deixe o resto em branco.</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="casos-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("casos/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nome_paciente"  value="<?php  echo $this->set_field_value('nome_paciente',""); ?>" type="text" placeholder="Nome Completo"  required="" name="nome_paciente"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-telefone"  value="<?php  echo $this->set_field_value('telefone',""); ?>" type="text" placeholder="Telefone ou Celular"  name="telefone"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select  id="ctrl-status_exame" name="status_exame"  placeholder="Selecione um valor ..."    class="custom-select" >
                                                            ...
                                                            $value = $option['value'];
                                                            $label = $option['label'];
                                                            $selected = $this->set_field_selected('status_exame', $value, "");
                                                            ?>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-origem"  value="<?php  echo $this->set_field_value('origem',""); ?>" type="text" placeholder="Origem do Caso" list="origem_list"  name="origem"  class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-local_coleta"  value="<?php  echo $this->set_field_value('local_coleta',""); ?>" type="text" placeholder="Onde foi coletado o exame?" list="local_coleta_list"  name="local_coleta"  class="form-control " />
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-tipo_exame"  value="<?php  echo $this->set_field_value('tipo_exame',""); ?>" type="text" placeholder="Qual o tipo de exame?" list="tipo_exame_list"  name="tipo_exame"  class="form-control " />
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select  id="ctrl-internado" name="internado"  placeholder="Selecione um valor ..."    class="custom-select" >
                                                                                ...
                                                                                $value = $option['value'];
                                                                                $label = $option['label'];
                                                                                $selected = $this->set_field_selected('internado', $value, "");
                                                                                ?>
                                                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                                    <?php echo $label ?>
                                                                                </option>                                   
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select  id="ctrl-resultado" name="resultado"  placeholder="Selecione um valor ..."    class="custom-select" >
                                                                                ...
                                                                                $value = $option['value'];
                                                                                $label = $option['label'];
                                                                                $selected = $this->set_field_selected('resultado', $value, "");
                                                                                ?>
                                                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                                    <?php echo $label ?>
                                                                                </option>                                   
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select  id="ctrl-caso_ativo" name="caso_ativo"  placeholder="Selecione um valor ..."    class="custom-select" >
                                                                                ...
                                                                                $value = $option['value'];
                                                                                $label = $option['label'];
                                                                                $selected = $this->set_field_selected('caso_ativo', $value, "");
                                                                                ?>
                                                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                                    <?php echo $label ?>
                                                                                </option>                                   
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    ...
                                                                                    $checked = $this->set_field_checked('obito', $value, "");
                                                                                    ?>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="input-group">
                                                                                        <input id="ctrl-data_obito" class="form-control datepicker  datepicker"  value="<?php  echo $this->set_field_value('data_obito',""); ?>" type="datetime" name="data_obito" placeholder="Selecione uma data" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                            <div class="input-group-append">
                                                                                                <span class="input-group-text"><i class="material-icons">date_range</i></span>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-inserido_por"  value="<?php echo USER_NAME?>" type="text" placeholder="Entrar  Inserido Por"  readonly name="inserido_por"  class="form-control " />
                                                                                            </div>
